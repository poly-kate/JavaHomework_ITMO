...
public class Step implements Serializable {
    ...
    private String text;
    private String nextFirst;//ссылка на первый вариант
    private String nextSecond;//ссылка на второй вариант
    ...
    public Step(String name) throws IOException {
        this.name=name;
        switch (name) {
            case "goHome":
    ...
    public void setStep(String title, String text, String nextFirst, String nextSecond) throws IOException {
        this.title=title;
        this.text=text;
    ...
    public void printStep() throws IOException {
        System.out.println("-----------------------------------------------------------------------------");
        ...
        do{
            ...
            switch (num){
                case 1:
                   ...
                   // else System.out.println("Тупик! Выберите другой пункт!");
                    break;
                case 2:
